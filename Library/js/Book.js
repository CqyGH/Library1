        ...
        success: function (json) {
            if (json.MessageCode == '0') {
                ...
                for (var i = 0; i < lists.length; i++) {
                    ...
                    if (lists[i]["BookType"]) {
                        BookTypeOption += "<option values='" + lists[i]["BookType"] + "'>" + lists[i]["BookType"] + "</option>";
                    }
                    else {
                        BookTypeOption = "";
                    }
                    ...
                    if (lists[i]["BookCase"]) {
                        BookCaseOption += "<option values='" + lists[i]["BookCase"] + "'>" + lists[i]["BookCase"] + "</option>";
                    }
                    else {
                        BookCaseOption = "";
                    }
...
//                    $("#BookCase").attr("value", _BookCase);
                    ...
                    $('#BookType').html(BookTypeOption);
                    $('#BookCase').html(BookCaseOption);
