...
function createPage(json) {
    ...
    optionHtml += ['<ul class="paginList"><li class="paginItem"><a href="javascript:;"><span class="pagepre"></span></a></li>'].join('');
    for (var i = 1; i <= pageNum; i++) {
        optionHtml += ['<li class="paginItem" onclick="SearchBook(' + i + ', 10)">' + i + '</li>'].join('');
    }
    optionHtml += [' <li class="paginItem"><a href="javascript:;"><span class="pagenxt"></span></a></li></ul>'].join('');
